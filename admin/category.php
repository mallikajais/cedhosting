...
<body>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="mb-0 text-sm">Hii<?php echo $_SESSION['name'];?></h4>
                          </div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      ...
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="mb-0 text-sm">Hi <?php echo $_SESSION['name'];?></h4>
                          </div>
                          <div class="text-right text-muted">
    ...
    <div class="container mt--8 pb-5">
              ...
              <form role="form">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                      <div class="input-group-prepend">
                          <textarea class="editor form-group link"  placeholder="HTML"></textarea>
                      </div>
                    </div>
                  </div>
                <div class="row my-4">
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-primary mt-4" id="createcategory" onclick="createcategory();">Create Category</button>
                </div>
              </form>
            </div>
          </div>
      ...
      <table class=" table table-striped table-hover table-border text-center " id="showProduct" >
            <thead>
        ...
        <div class="modal fade" id="mymodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSignTitle" aria-hidden="true">
                ...
                <form role="form">
                  ...
                  <label class="mr-sm-2" for="inlineFormCustomSelect">Sub Category</label>
                    <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="productname" type="text" id="productname-update" name="productname_update">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group input-group-merge input-group-alternative">
                      <div class="input-group-prepend">
                          <textarea class="editor form-group" placeholder="html" id="link-update" name="link_update"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="mr-sm-2" for="inlineFormCustomSelect">Availability</label>
                    <select class="custom-select mr-sm-2" id="availability-update" name="availability-update">
   ...
   $(document).ready(function() {
    ...
    function showProduct(){
          $('#showProduct').DataTable( {
              "ajax": "handlerequest.php?showproduct"
          } ); 
    }
